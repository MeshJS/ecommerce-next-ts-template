...
const product = {
  ...
  href: "/product",
  breadcrumbs: [
    { id: 1, name: "Men", href: "/collection" },
    { id: 2, name: "Clothing", href: "/collection" },
  ],
  images: [
    {
      src: "/product-page-02-secondary-product-shot.jpg",
      alt: "Two each of gray, white, and black shirts laying flat.",
    },
    {
      src: "/product-page-02-tertiary-product-shot-01.jpg",
      alt: "Model wearing plain black basic tee.",
    },
    {
      src: "/product-page-02-tertiary-product-shot-02.jpg",
      alt: "Model wearing plain gray basic tee.",
    },
    {
      src: "/product-page-02-featured-product-shot.jpg",
    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          ...
          {loading === false && txHash === undefined && (
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">
                    A transaction window will open, please check the transaction
                    and sign to approve it.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  ...
                  {success && (
                    <p className="text-sm text-gray-600">
                      The receipt has been minted in your wallet. Thank you for
                      supporting Mesh SDK development.
                    </p>
                  )}
                </div>
              </div>
